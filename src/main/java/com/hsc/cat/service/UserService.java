    	...
    	ResponseTO responseTO=new ResponseTO();
    	 ...
    	 if(validateParameter(empId) && validateParameter(securityQuestion)  && validateParameter(answer) ) {
    		 ...
    		 if(null!=employeeDetails) {
    			 if((employeeDetails.getSecurityQues1().equalsIgnoreCase(securityQuestion) && bCryptPasswordEncoder.matches(answer, employeeDetails.getSecurityAns1())) ||
    					 (employeeDetails.getSecurityQues1().equalsIgnoreCase(securityQuestion) && bCryptPasswordEncoder.matches(answer, employeeDetails.getSecurityAns2())) ) {
