...
//	}
	...
	@ResponseBody
    @RequestMapping(value =RESTURLConstants.PASSWORD_RESET, method = RequestMethod.PUT)
	...
	@ResponseBody
    @RequestMapping(value = RESTURLConstants.USER_DELETION, method = RequestMethod.DELETE)
	...
	@ResponseBody
    @RequestMapping(value = RESTURLConstants.LOGIN, method = RequestMethod.POST)
...
//		/System.out.println(securityService.findLoggedInUsername());
    ...
    @RequestMapping(value = RESTURLConstants.LOGOUT, method = RequestMethod.GET)
	...
	@RequestMapping(value="cat/auth/forgetPassword",method=RequestMethod.POST)
	@ResponseBody
	@CrossOrigin
	public ResponseTO forgetPassword(@RequestBody ForgetPasswordVO forgetPasswordVO) {
		
		ResponseTO responseTO=null;
		responseTO=userService.forgetPasswordForAll(forgetPasswordVO);
